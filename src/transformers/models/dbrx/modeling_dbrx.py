...
class DbrxFlashAttention2(DbrxAttention):
    ...
    def _flash_attention_forward(
        ...
        if attention_mask is not None:
            ...
            query_states, key_states, value_states, indices_q, cu_seq_lens, max_seq_lens = reshape_func(
            ...
            attn_output = flatten_func(attn_output_unpad, indices_q, batch_size, query_length)
        else:
