...
class MixtralFlashAttention2(MixtralAttention):
    ...
    def _flash_attention_forward(
        ...
        if attention_mask is not None:
            ...
            query_states, key_states, value_states, indices_q, cu_seq_lens, max_seq_lens = unpad_func(
            ...
            attn_output = pad_func(attn_output_unpad, indices_q, batch_size, query_length)
        else:
            if not use_sliding_windows:
